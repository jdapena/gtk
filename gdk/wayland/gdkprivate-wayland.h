...
GdkKeymap *_gdk_wayland_keymap_new_from_fd (GdkDisplay *display,
					    uint32_t format,
...
void       _gdk_wayland_display_set_keymap (GdkDisplay *display,
					    GdkKeymap *keymap);
...
void              _gdk_wayland_device_manager_add_device (GdkDeviceManager *device_manager,
							  struct wl_seat *seat);
struct wl_seat *_gdk_wayland_device_get_device (GdkDevice *device);
